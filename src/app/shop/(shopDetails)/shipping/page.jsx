...
const Shipping = () => {
  ...
  return (
    <div className={styles.container}>
      <span className={styles.heading}>Shipping details</span>
      <Formik
        initialValues={{
          contactNumber: "",
          addressLine1: "",
          ...
          <Form className={styles.form}>
            <div className={styles.row}>
              <div className={styles["postcode"]}>
                <label className={styles.genLabel} htmlFor="fullName">
                  Full Name
                </label>
                <Field
                  type="text"
              ...
              <div className={styles["email"]}>
                <label className={styles.genLabel} htmlFor="email">
                  Phone Number
                </label>
                ...
                <div className={styles.number}>
                  ...
                  <Field
                    ...
                    name="contactNumber"
                    className={`${styles.formInput} ${
                      values.contactNumber ? styles["is-valid"] : ""
                    }`}
                    required
                  />
                  <ErrorMessage
            ...
            <div className={styles["address"]}>
              <label className={styles.genLabel} htmlFor="addressLine1">
              ...
              <div className={styles.input}>
                <Field
                  ...
                  name="addressLine1"
                  className={`${styles.formInput} ${
                    values.addressLine1 ? styles["is-valid"] : ""
                  }`}
                  required
                />
            ...
            <div className={styles.address}>
              <label className={styles.genLabel} htmlFor="addressLine2">
                Second line with state name
              </label>
              <div className={styles.input}>
                <Field
                  type="text"
                  name="addressLine2"
                  className={`${styles.formInput} ${
                    values.addressLine2 ? styles["is-valid"] : ""
                  }`}
                  required
                />
            ...
            <div className={styles.row}>
              <div className={styles["postcode"]}>
                <label className={styles.genLabel} htmlFor="postcode">
                  Postcode
                </label>
                <Field
                  type="number"
