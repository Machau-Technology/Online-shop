    ...
    <div className={styles.container}>
      ...
      <div className={styles.others}>
        <div className={styles.col}>
          ...
          <Link href="/shop/master-sticker/ms-100" className={styles.circLink}>
        ...
        <div className={styles.col}>
          ...
          <Link href="/shop/master-sticker/ms-150" className={styles.circLink}>
            <button className={styles.circShop}>Shop now</button>
          </Link>
        </div>
        <div className={styles.col}>
          ...
          <Link href="/shop" className={styles.circLink}>
            <button className={styles.circShop}>Shop now</button>
          </Link>
        </div>
      </div>
