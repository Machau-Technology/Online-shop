                                ...
                                <div className={styles.product}>
                                    ...
                                    <div className={styles.productDetails}>
                                        ...
                                        <button className={styles.btn1}>
                                            <span
                                                className={styles.calc}
                                                onClick={() => updateCountSticker100(stickerCount100 - 1)}
                                            ><b>--</b></span>
                                ...
                                <div className={styles.product}>
                                    ...
                                    <div className={styles.productDetails}>
                                        ...
                                        <button className={styles.btn1}>
                                            <span
                                                className={styles.calc}
                                                onClick={() => updateCountSticker150(stickerCount150 - 1)}
                                            ><b>--</b></span>
                    ...
                    <div className={styles.circleSection}>
                        {(!tagShop) &&
                            <div className={styles.col}>
                                ...
                                <button
                                    className={styles.circShop}
                                    onClick={addTagToCart}
                                >
                                    Add to cart
                                </button>
                            </div>
